...
?>
    ...
    <h2 id="h2_ki_id" style="color:#55a1e4;">Patients Login</h2>
</div>
...
<div class="appointment_table_div_admin" class="table-container" style="width: 100%; overflow-x: auto;">
    ...
    <thead class="table">
            <tr>
                <th style="background-color: #83baeb; color:white; border-left: 1px solid #83baeb;" scope="col">Name</th>
                <th style="background-color: #83baeb; color:white;" scope="col">User Name</th>
                <th style="background-color: #83baeb; color:white;" scope="col">Email</th>
                <th style="background-color: #83baeb; color:white;" scope="col">Login Time</th>
                <th style="background-color: #83baeb; color:white;" scope="col">Login Date</th>
                <th style="background-color: #83baeb; color:white;" scope="col">Logout Time</th>
                <th style="background-color: #83baeb; color:white; border-right: 1px solid #83baeb;" scope="col">Logout Date</th>
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid lightgrey; padding: 8px;"><?php echo $row['user_name']; ?></td>
                        <td style="border: 1px solid lightgrey; padding: 8px;"><?php echo $row['email']; ?></td>
                        <td style="border: 1px solid lightgrey; padding: 8px;"><?php echo $row['start_time']; ?></td>
                        <td style="border: 1px solid lightgrey; padding: 8px;"><?php echo $row['start_date']; ?></td>
                        <td style="border: 1px solid lightgrey; padding: 8px;"><?php echo $row['end_time']; ?></td>
                        <td style="border: 1px solid lightgrey; padding: 8px;"><?php echo $row['end_date']; ?></td>
                    </tr>
                    <?php
                }
            }
