...
<?php 
include "config.php";
$get_vaccinated_appointment = "SELECT * FROM users WHERE status = 'Approved' AND appointment = 'Vaccinated' And report = 'Inprocess' And send_report = 'Unsent'";
$vaccinated_appointment_result = $con->query($get_vaccinated_appointment);

?>

<div style="margin-bottom:-25px;" class="section-title">
    <h2 id="h2_ki_id" style="color:#55a1e4;">Vaccinated Patients</h2>
</div>
  ...
  <table class="table" style="width: 100%; white-space: nowrap;">
    <thead class="table-dark border">
      <tr>
        ...
        <th scope="col" style="background-color: #83baeb; color:white; border-right: 1px solid #83baeb; padding: 8px;">Vaccine Status</th>
      </tr>
    </thead>
<tbody>
