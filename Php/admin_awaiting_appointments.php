...
$get_vaccinated_appointment = "SELECT * FROM users WHERE status = 'Approved' AND appointment = 'Pending' AND report = 'inprocess' AND send_report = 'Unsent'";
$vaccinated_appointment_result = $con->query($get_vaccinated_appointment);

?>

<div style="margin-bottom:-25px;" class="section-title">
    <h2 id="h2_ki_id" style="color:#55a1e4;">Awaiting Vaccinations</h2>
</div>
