...
?>
    ...
    <h2 id="h2_ki_id" style="color:#55a1e4;">Patients Register</h2>
</div>
...
<div class="appointment_table_div_admin" class="table-container" style="width: 100%; overflow-x: auto;">
    ...
    <thead class="table">
            <tr>
                <th style="background-color: #83baeb; color:white; border-left: 1px solid #83baeb;" scope="col">Patient Name</th>
                <th style="background-color: #83baeb; color:white;" scope="col">Username</th>
                <th style="background-color: #83baeb; color:white;" scope="col">Email</th>
                <th style="background-color: #83baeb; color:white; border-right: 1px solid #83baeb;" scope="col">Password</th>
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid lightgrey; padding: 8px;"><?php echo $row['username']; ?></td>
