...
<div style="margin-bottom:-25px;" class="section-title">
    <h2 id="h2_ki_id" style="color:#55a1e4;">Hospitals Register</h2>
</div>
...
<div class="appointment_table_div_admin" class="table-container" style="width: 100%; overflow-x: auto;">
    ...
    <thead class="table">
            <tr>
                ...
                <th style="background-color: #83baeb; color:white;" scope="col">Contact</th>
        ...
        <tbody>
            ...
            $sql = "SELECT * FROM center_sign_up";
