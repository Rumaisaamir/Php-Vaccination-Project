...
<div id="list">
  ...
  <?php } ?>
        ...
        <a href="../php/user_profile.php" class="twitter"><i class="bi bi-person-fill"></i> Profile</a>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#departments">Hospitals</a></li>
  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p>Have questions or need assistance? We're here to help! Please feel free to reach out to us for any inquiries related to vaccination, healthcare services, or general information. Your health and well-being are our top priorities, and we look forward to assisting you.</p>
        </div>
      </div>

      <div>
        <iframe style="border:0; width: 100%; height: 350px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3618.634324577536!2d67.02549227424863!3d24.91045194325744!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb33fb94eb666b5%3A0x6e383e3adce474a4!2sAptech%20Computer%20Education%20Site%20Center!5e0!3m2!1sen!2s!4v1694174799062!5m2!1sen!2s" frameborder="0" allowfullscreen></iframe>
      </div>
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>7936 Ghani Street, Karachi 24700 Pakistan</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>vaxease@gmail.com</p>
              </div>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="send.php" method="post" role="form" class="php-email-form">
              ...
              <div class="text-center"><button type="submit" name="contact_send">Send Message</button></div>
            </form>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <form action="subscribe.php" method="post" onsubmit="return validateEmail();">
              <input class="subscriber_email" style="text-decoration:none; border:none;" type="text" name="news_email" placeholder="Enter email address"><input type="submit" name="subscribe" value="Subscribe">
            </form>
          </div>
  ...
  <script>
    function validateEmail() {
      var email = document.querySelector("input[name='news_email']").value;
    ...
    var emailInput = document.querySelector(".subscriber_email");
