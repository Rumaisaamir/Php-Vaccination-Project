...
<h2 id="h2_ki_id_doctor_2" style="color:#55a1e4;">Generate Appointment Report</h2>
</div>
...
?>
        ...
        <form action="send_generate_report.php" id="vaccinationForm" method="post">
            
        <label for="name">Name:</label>
        <input class="report_input" type="text" id="name" value="<?php echo $row['Name']; ?>" name="name" required readonly>

        <label for="batchNo">Appointment Id</label>
        <input class="report_input" type="text" id="appointmentId" value="<?php echo $row['appointment_id']; ?>" name="appointmentId" required readonly>

        <label for="age">Age:</label>
        <input class="report_input" type="text" id="age" value="<?php echo $row['Age']; ?>" name="age" required readonly>

        <label for="patientId">Contact No.</label>
        <input class="report_input" type="text" id="contactNo" value="<?php echo $row['Contact_Number']; ?>"name="contactNo" required readonly>

        <label for="nic_number">NIC Number:</label>
        <input class="report_input" type="text" id="nic_number"  value="<?php echo $row['NIC_Number']; ?>"name="nic_number" required readonly>

        <label for="dob">Gender:</label>
        <input class="report_input" type="text" id="gender" value="<?php echo $row['Gender']; ?>" name="gender" required readonly>

        <label for="location">Hospital:</label>
        <input class="report_input" type="text" id="hospital" value="<?php echo $row['Preferred_Center']; ?>" name="hospital" required readonly>

        <label for="dob">Date of Vaccination:</label>
        <input class="report_input" type="text" id="dateOfVaccination" value="<?php echo $row['Date_of_Vaccination']; ?>" name="dateOfVaccination" required readonly>

        <label for="time">Time of Vaccination:</label>
        <input class="report_input" type="text" id="time"  value="<?php echo $row['Booking_Slots']; ?>"name="time" required readonly>

        <label for="dosage">Dosage:</label>
        <input class="report_input" type="text" id="dosage"  value="<?php echo $row['Dose']; ?>"name="dosage" required readonly>

        <label for="manufacturer">Manufacturer:</label>
        <input class="report_input" type="text" id="vaccinationtype" value="<?php echo $row['Vaccination_Type']; ?>" name="vaccinationtype" required readonly>

        <label for="manufacturer">Result:</label>
        <input class="report_input" type="text" id="result" name="result" required>

        <input class="report_input" type="hidden" id="email" value="<?php echo $row['Email_Address']; ?>" name="email" required readonly>

        <input title="Generate Report" style="padding:0px 15px 0px 15px; border-radius: 0px; margin-top:10px;" id="approve_btns" class="btn" type="submit" value="Generate" name="send_report">
        <!-- <input class="report_btn" type="submit" value="Submit"> -->
    </form>
...
if(isset($_POST['send_report'])){
    ...
    if ($stmt->execute()) {
        ...
        if ($update_stmt->execute()) {
            echo "<script>alert('Report generated. Please send the report to the patient.'); window.location.href = 'send_report_db.php';</script>";
        } else {
